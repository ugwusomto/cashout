        ...
        <div class="container">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="action-sheet-content">
                            <form data-form="processWithdraw" class="cashout_form" action="<?=APP_PATH?>api/process.php" method="POST">

                            <div class="messageBox  text-center"></div>

                                <div class="form-group basic">
                                    <div class="input-wrapper">
                                        <label class="label" for="account1">Account</label>
                                        <select name="bank_account" required class="form-control custom-select" id="account1">
                                ...
                                <div class="form-group basic">
                                    <div class="input-wrapper">
                                        <label class="label" for="account1">Bank 
                                             <?php if(empty($userBanks)){ ?>
                                                ( You haven't added any bank info <a data-form="add_bank_form" class="ba-add-balance-btn text-danger" href="#">ADD BANK</a> )
                                             <?php } ?></label>
                                        <select name="account" required class="form-control custom-select" id="account1">
                                            <option value="">Select Bank</option>
                                            <?php foreach($userBanks as $key => $bank){ $bank = (object) $bank; ?>
                                            <option value="<?=$bank->id?>"><?=ucwords($bank->name)?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group basic">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" required name="amount" class="form-control form-control-lg" value="">
                                    </div>
                                </div>

                                <div class="form-group basic">
                                    <button data-name="Withdraw" data-process="Processing..." type="submit" class="btn-c btn-primary btn-block btn-lg"
                                        >Withdraw</button>
                                </div>
                            </form>
                        </div>
